...
const contains = x => xs => (0, _Array.member)(_Setoid.setoidStrict)(xs, x);
/**
 * Combines two lists into a set (i.e. no duplicates)
 * composed of the elements of each list. Uses strict equality for comparisons
 *
 * NOTE: You should probably convert to a Set and use `union` from the
 * 'fp-ts/lib/Set' module instead
 */


exports.contains = contains;

const union = (xs, ys) => (0, _Array.uniq)(_Setoid.setoidStrict)(_Array.array.alt(xs, ys));
/**
...
const sortByAlpha = (0, _Array.sort)(_String.ordAlpha);
/**
 * Sorts an array of strings numerically
 */

exports.sortByAlpha = sortByAlpha;
const sortByNumeric = (0, _Array.sort)(_Number.ordNumeric);
/**
