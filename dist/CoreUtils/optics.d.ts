 ...
 */
export declare const lensesFromRecord: <A extends {
    [key: string]: unknown;
}, K extends keyof A & string, LensRecord extends { [P in K]: Lens<A, A[P]>; }, LensRecord_ extends {
    [key: string]: Lens<A, A[K]>;
}>(x: A) => LensRecord;
/**
 ...
 */
export declare const mkRecordKeyOptional: <S extends Record<K, A>, K extends keyof S & string, A extends S[K]>(k: K) => Optional<S, A>;
