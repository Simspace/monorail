...
})(["", ";", ";background:#f4f4f7;box-sizing:border-box;flex-shrink:0;position:relative;z-index:5;will-change:width;&::after{background:linear-gradient( to right,rgba(0,0,0,0.1) 0px,rgba(0,0,0,0.1) 1px,rgba(0,0,0,0.05) 1px,rgba(0,0,0,0) 100% );bottom:0;content:'';position:absolute;right:-3px;top:0;width:3px;}"], (0, _CommonStyles.flexFlow)(), _CommonStyles.gothamFontFamily);
...
})(["", ";flex:1;overflow-y:auto;padding:0 8px;", ";"], (0, _CommonStyles.flexFlow)(), ({
  cssOverrides
}) => cssOverrides);
