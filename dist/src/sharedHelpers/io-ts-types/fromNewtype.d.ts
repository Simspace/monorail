 ...
 * @since 0.5.2
 */
export declare function fromNewtype<N extends AnyNewtype = never>(codec: t.Type<CarrierOf<N>, t.OutputOf<CarrierOf<N>>>, name?: string): t.Type<N, CarrierOf<N>, unknown>;
//# sourceMappingURL=fromNewtype.d.ts.map