...
/** InfoButton */
export declare type InfoButtonProps = {
    info: string;
};
export declare type InfoButtonAction = {
...
export declare type ActionsButtonsAction = ActionsMenuAction | DropdownButtonAction | IconButtonActionWithCheck | InfoButtonAction | TextButtonActionWithCheck;
