...
export declare type FormMultiSelectInputProps<A> = {
    ...
    readonly renderSelectedOptions: (selectedOptions: ReadonlyArray<A>, removeOption: (value: A) => void) => React.ReactElement | null;
    /** Render input component as you will */
    readonly renderInput: (props: GetInputPropsOptions) => React.ReactElement | null;
    /** Render suggestions as you would like */
    readonly renderSuggestions: (suggestions: ReadonlyArray<A>, additionalInfo: SuggestionInfo<A>) => React.ReactElement | null;
    /**
     * Get the suggested values.
     * Allows customizing the search algorithm.
     */
    readonly getSuggestedValues: (searchValue: string, options: ReadonlyArray<A>) => ReadonlyArray<A>;
    /**
     * Edit or View mode
    ...
    readonly containerCss?: string | CSSObject | FlattenInterpolation<ThemeProps<GlobalAppThemeInterface>>;
    /** Required in form */
...
export declare type SuggestionInfo<A> = {
    readonly selectedOptions: ReadonlyArray<A>;
    readonly searchValue: string;
    readonly isFocused: boolean;
    readonly isOpen: boolean;
    readonly isHighlighted: (option: A) => boolean;
    readonly getSuggestionProps: <B = HTMLElement>(options: GetItemPropsOptions<A>) => Omit<GetItemPropsOptions<A>, 'ref' | 'as'> & {
