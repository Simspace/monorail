...
_styledComponents.default.div.withConfig({
  ...
  cssOverrides
}) => (0, _styledComponents.css)(["display:flex;height:100%;width:100%;justify-content:center;"]));
...
_styledComponents.default.div.withConfig({
  ...
  darkMode
}) => (0, _styledComponents.css)(["padding:10px;position:relative;background-color:", ";.icon{position:absolute;left:5px;top:5px;svg{fill:#1465ff;}}"], darkMode ? 'hsla(234,56%,20%,1)' : 'white'));
...
_styledComponents.default.div.withConfig({
  ...
  darkMode
}) => (0, _styledComponents.css)(["border-style:solid;border-width:2px;border-color:", ";align-items:center;border-radius:50%;width:25px;height:25px;position:relative;"], darkMode ? 'white' : 'rgba(0, 0, 0, 0.54)')); // Needed to have this because otherwise
...
_styledComponents.default.div.withConfig({
  ...
  darkMode
}) => (0, _styledComponents.css)(["color:", ";font-weight:bold;position:absolute;justify-content:center;align-items:center;height:100%;width:100%;display:flex;"], darkMode ? 'white' : 'rgba(0, 0, 0, 0.54)'));
...
_styledComponents.default.div.withConfig({
  ...
  darkMode
}) => (0, _styledComponents.css)(["display:flex;flex-direction:column;background-color:", ";padding-right:10px;"], darkMode ? 'hsla(234,56%,20%,1)' : 'white'));
...
_styledComponents.default.div.withConfig({
  ...
  darkMode
}) => (0, _styledComponents.css)(["color:", ";font-size:13px;font-weight:bold;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"], darkMode ? 'white' : 'black'));
...
_styledComponents.default.div.withConfig({
  ...
  darkMode
}) => (0, _styledComponents.css)(["color:", ";font-size:11px;opacity:0.7;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"], darkMode ? 'white' : 'black'));
