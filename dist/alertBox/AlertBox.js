...
_styledComponents.default.div.withConfig({
  ...
  cssOverrides
}) => (0, _styledComponents.css)(["", ";background-color:", ";border-radius:4px;flex-shrink:0;height:48px;position:relative;&::before{bottom:8px;content:'';left:16px;position:absolute;width:32px;}", ";"], (0, _CommonStyles.flexFlow)('row'), (0, _CommonStyles.colors)(_CommonStyles.Colors.Red, 0.15), cssOverrides));
