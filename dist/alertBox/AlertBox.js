...
_styledComponents.default.div.withConfig({
  ...
  cssOverrides
}) => (0, _styledComponents.css)(["", ";background-color:", ";border-radius:4px;flex-shrink:0;height:48px;position:relative;&::before{bottom:8px;content:'';left:16px;position:absolute;width:32px;}", ";"], (0, _exports.flexFlow)('row'), (0, _exports.getColor)(_exports.Colors.Red, 0.15), cssOverrides));
...
})(["", ";color:", ";margin:16px 0;"], (0, _exports.typography)(700, _exports.FontSizes.Title3), (0, _exports.getColor)(_exports.Colors.Black89));
...
})(["", ";color:", ";margin:auto 48px auto auto;"], (0, _exports.typography)(300, _exports.FontSizes.Content), (0, _exports.getColor)(_exports.Colors.Black89));
