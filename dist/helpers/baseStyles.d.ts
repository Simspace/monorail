...
export declare const basePrimaryStyles: (color?: ThemeColors, backgroundColor?: ThemeColors) => import("styled-components").FlattenInterpolation<import("styled-components").ThemeProps<import("./theme").GlobalAppThemeInterface>>;
