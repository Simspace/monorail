 ...
 */
export declare const mkJSONOptionDecoderSelector: <A>(codec: t.Type<Option<A>, JSONOption<A>, unknown>) => <S>(getter: Getter<S, JSONOption<A>> | Lens<S, JSONOption<A>>) => (s: S) => Option<A>;
