...
const TabBarContainer = /*#__PURE__*/_styledComponents.default.div.withConfig({
...
const TabBarIndicatorContainer = /*#__PURE__*/(0, _styledComponents.default)(({
  left,
  width,
  duration,
  ...otherProps
}) => /*#__PURE__*/_react.default.createElement("div", otherProps, /*#__PURE__*/_react.default.createElement(TabBarIndicatorLeft, null), /*#__PURE__*/_react.default.createElement(TabBarIndicatorBody, {
  duration: duration,
  width: width
}), /*#__PURE__*/_react.default.createElement(TabBarIndicatorRight, {
  duration: duration,
  width: width
}))).withConfig({
...
const TabBarIndicatorLeft = /*#__PURE__*/_styledComponents.default.div.withConfig({
...
const TabBarIndicatorRight = /*#__PURE__*/(0, _styledComponents.default)(({
  duration,
  width,
  ...otherProps
}) => /*#__PURE__*/_react.default.createElement("div", otherProps)).withConfig({
...
const TabBarIndicatorBody = /*#__PURE__*/(0, _styledComponents.default)(({
  duration,
  width,
  ...otherProps
}) => /*#__PURE__*/_react.default.createElement("div", otherProps)).withConfig({
...
class TabBar extends _react.Component {
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(TabBarContainer, _extends({
      cssOverrides: cssOverrides,
      size: size
    }, domProps), /*#__PURE__*/_react.default.createElement(_HorizontalNavigationController.HorizontalNavigationController, {
      actions: actions,
      tabBarIndicator: props => /*#__PURE__*/_react.default.createElement(TabBarIndicatorContainer, props),
