...
exports.MediumLargeModal = void 0;
...
var _StyledBBModalBackground = /*#__PURE__*/(0, _styledComponents.default)(_Modals.BBModalBackground).withConfig({
  displayName: "MediumLargeModal___StyledBBModalBackground",
  componentId: "sc-1f2aohg-0"
})(["", ""], p => p._css);

const MediumLargeModal = props => {
  const {
    isOpen,
    onClick,
    children,
  ...
  return /*#__PURE__*/_react.default.createElement(_Overlay.Overlay, {
    ...
    size: _modalTypes.ModalSize.MediumLarge
  }, otherProps, {
...
exports.MediumLargeModal = MediumLargeModal;