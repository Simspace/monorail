...
const NumberInputGroup = ({
  ...
  return _react.default.createElement(NumberInputGroupWrapper, null, label && _react.default.createElement(_StyledLabel, {
    label: label,
    required: required
  }), items.map((item, k) => {
...
var _StyledLabel = (0, _styledComponents.default)(_Label.Label)`
            margin-bottom: 8px;
            height: 16px;
          `;