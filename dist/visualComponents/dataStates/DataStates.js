...
exports.NoResultsIcon = exports.IconBox = exports.Detail = exports.Banner = exports.CustomNoResults = exports.CustomNoData = exports.DetailContainer = exports.NotFound = exports.SomethingWentWrong = exports.NotAuthorized = exports.NoModules = exports.NoData = exports.NoCompletedEvents = exports.NoEvents = exports.EmptyTable = exports.NoResults = exports.NoResultsCollection = void 0;
...
const NoResultsCollection = () => /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(NoResultsIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, "No Entries Found"), /*#__PURE__*/_react.default.createElement(Detail, null, /*#__PURE__*/_react.default.createElement("span", null, "We couldn't find any records that match your search."), /*#__PURE__*/_react.default.createElement("span", null, "Please try again or browse the libraries.")));

exports.NoResultsCollection = NoResultsCollection;

const NoResults = props => /*#__PURE__*/_react.default.createElement(_StyledContainer, {
  _css: props.cssOverrides
}, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(NoResultsIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, "No Entries Found"), /*#__PURE__*/_react.default.createElement(Detail, null, "We couldn't find any records that match your search."));

exports.NoResults = NoResults;

var _StyledNoResults2 = /*#__PURE__*/(0, _styledComponents.default)(NoResults).withConfig({
  displayName: "DataStates___StyledNoResults2",
  componentId: "sc-19xnotc-0"
})(["", ""], p => p._css4);

var _StyledNoResults = /*#__PURE__*/(0, _styledComponents.default)(NoResults).withConfig({
  displayName: "DataStates___StyledNoResults",
  componentId: "sc-19xnotc-1"
})(["", ""], p => p._css3);

const EmptyTable = () => /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(NoResultsIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, "No Entries Found"), /*#__PURE__*/_react.default.createElement(Detail, null, "We couldn't find any records."));

exports.EmptyTable = EmptyTable;

const NoEvents = () => /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(NoResultsIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, "No Events"), /*#__PURE__*/_react.default.createElement(Detail, null, "Events that you are participating in will be listed here."));

exports.NoEvents = NoEvents;

const NoCompletedEvents = () => /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(NoResultsIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, "No Events"), /*#__PURE__*/_react.default.createElement(Detail, null, "This area lists the events that you have completed."));

exports.NoCompletedEvents = NoCompletedEvents;

const NoData = () => /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(NoResultsIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, "There's Nothing Here"), /*#__PURE__*/_react.default.createElement(Detail, null, /*#__PURE__*/_react.default.createElement("span", null)));

exports.NoData = NoData;

const NoModules = () => /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(NoResultsIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, "No Modules Found"));

exports.NoModules = NoModules;

const NotAuthorized = () => /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(NotAuthorizedIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, "Not Authorized"), /*#__PURE__*/_react.default.createElement(Detail, null, /*#__PURE__*/_react.default.createElement("span", null, "We could not verify that you are authorized to access"), /*#__PURE__*/_react.default.createElement("span", null, "the requested page. Sorry!")));

exports.NotAuthorized = NotAuthorized;

const SomethingWentWrong = () => /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(SomethingWentWrongIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, "Something Went Wrong"), /*#__PURE__*/_react.default.createElement(Detail, null, /*#__PURE__*/_react.default.createElement("span", null, "We wish we could be more specific, but that's all we know. Did you try turning it off and on again?")));

exports.SomethingWentWrong = SomethingWentWrong;

const NotFound = () => /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(NotFoundIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, "We couldn't find your page..."), /*#__PURE__*/_react.default.createElement(Detail, null, /*#__PURE__*/_react.default.createElement("span", null, "We searched high and low, far and wide"), /*#__PURE__*/_react.default.createElement("span", null, "but can't seem to find the page you're looking for.")));

exports.NotFound = NotFound;

const DetailContainer = /*#__PURE__*/_styledComponents.default.div.withConfig({
...
const CustomNoData = ({
  ...
  details,
  vertical = false,
  icon = /*#__PURE__*/_react.default.createElement(NoResultsIcon, null),
  ...domProps
}) => /*#__PURE__*/_react.default.createElement(Container, _extends({
  vertical: vertical
}, domProps), /*#__PURE__*/_react.default.createElement(IconBox, null, icon), /*#__PURE__*/_react.default.createElement(DetailContainer, {
  vertical: vertical
}, /*#__PURE__*/_react.default.createElement(Banner, null, headingText), /*#__PURE__*/_react.default.createElement(Detail, {
  vertical: vertical
}, details)));
...
const CustomNoResults = props => {
  ...
  return (0, _pipeable.pipe)((0, _Apply.sequenceT)(O.option)(bannerText, detailText), O.map(([bannerText_, detailText_]) => {
    if (bannerText_ || detailText_) {
      return /*#__PURE__*/_react.default.createElement(_StyledContainer2, {
        _css2: cssOverrides
      }, /*#__PURE__*/_react.default.createElement(IconBox, null, /*#__PURE__*/_react.default.createElement(NoResultsIcon, null)), /*#__PURE__*/_react.default.createElement(Banner, null, O.getOrElse(() => '')(bannerText)), O.getOrElse(() => '')(detailText).split('.').map((str, idx) => {
        return /*#__PURE__*/_react.default.createElement(Detail, {
          key: idx + str
        }, str, str.length > 0 && '.');
      }));
    } else {
      return /*#__PURE__*/_react.default.createElement(_StyledNoResults, {
        _css3: cssOverrides
      });
    }
  }), O.getOrElse(() => /*#__PURE__*/_react.default.createElement(_StyledNoResults2, {
    _css4: cssOverrides
  })));
};
...
const Banner = /*#__PURE__*/_styledComponents.default.div.withConfig({
...
var _StyledContainer2 = /*#__PURE__*/(0, _styledComponents.default)(Container).withConfig({
  displayName: "DataStates___StyledContainer2",
  componentId: "sc-19xnotc-5"
})(["", ""], p => p._css2);

var _StyledContainer = /*#__PURE__*/(0, _styledComponents.default)(Container).withConfig({
  displayName: "DataStates___StyledContainer",
  componentId: "sc-19xnotc-6"
})(["", ""], p => p._css);

const Detail = /*#__PURE__*/_styledComponents.default.div.withConfig({
...
const IconBox = /*#__PURE__*/_styledComponents.default.div.withConfig({
...
const NoResultsIcon = () => /*#__PURE__*/_react.default.createElement("svg", {
  width: "135",
  height: "135",
  viewBox: "0 0 135 135",
  fill: "none",
...
const NotAuthorizedIcon = () => /*#__PURE__*/_react.default.createElement("svg", {
  width: "120",
  height: "120",
  viewBox: "0 0 120 120",
  fill: "none",
...
const SomethingWentWrongIcon = () => /*#__PURE__*/_react.default.createElement("svg", {
  width: "140",
  height: "140",
  viewBox: "0 0 140 140",
  fill: "none",
...
const NotFoundIcon = () => /*#__PURE__*/_react.default.createElement("svg", {
  width: "185",
  height: "68",
  viewBox: "0 0 185 68",
  fill: "none",
