...
const BBCardContent = /*#__PURE__*/_styledComponents.default.div.withConfig({
...
const BBCardBackground = /*#__PURE__*/(0, _styledComponents.default)( /*#__PURE__*/(0, _react.forwardRef)(({
  children,
  cssOverrides,
  hover,
  elevation,
  ...
  ref: ref
}, otherProps), /*#__PURE__*/_react.default.createElement(BBCardContent, {
...
const BBCardHeaderContainer = /*#__PURE__*/_styledComponents.default.div.withConfig({
...
const BBCardHeaderTitle = /*#__PURE__*/_styledComponents.default.h1.withConfig({
  displayName: "Cards__BBCardHeaderTitle",
  componentId: "sc-1i66uhi-3"
})(["", ";"], (0, _exports.typographyFont)(700, _exports.FontSizes.Title5));

const StyledAppIconLeft = /*#__PURE__*/(0, _styledComponents.default)(_AppIcon.AppIcon).withConfig({
  displayName: "Cards__StyledAppIconLeft",
  componentId: "sc-1i66uhi-4"
})(["margin-right:16px;"]);
const StyledIconLeft = /*#__PURE__*/(0, _styledComponents.default)(_Icon.Icon).withConfig({
  displayName: "Cards__StyledIconLeft",
  componentId: "sc-1i66uhi-5"
})(["margin-right:16px;"]);
const StyledIconRight = /*#__PURE__*/(0, _styledComponents.default)(_Icon.Icon).withConfig({
  displayName: "Cards__StyledIconRight",
  componentId: "sc-1i66uhi-6"
})(["margin-left:16px;"]);

const BBCardBottomBorder = /*#__PURE__*/_styledComponents.default.div.withConfig({
...
const BBCardHeader = ({
  ...
  noBorder,
  title
}) => /*#__PURE__*/_react.default.createElement(BBCardHeaderContainer, {
  ...
  icon: iconLeft
}), /*#__PURE__*/_react.default.createElement(BBCardHeaderTitle, null, title), iconRight && /*#__PURE__*/_react.default.createElement(StyledIconRight, {
  icon: iconRight
}), children, !noBorder && /*#__PURE__*/_react.default.createElement(BBCardBottomBorder, {
  accentColor: accentColor
})); // building-blocks/cards/card-grid


exports.BBCardHeader = BBCardHeader;
const BBCardGrid = /*#__PURE__*/(0, _styledComponents.default)(_ScrollAnimation.ScrollAnimation).withConfig({
