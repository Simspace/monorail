...
type CheckedFiltersData = { filters: Array<FilterWithCheckedData> }
...
type FilterOptionsData = { filters: Array<FilterOption> }
...
export type AppliedFilters = { filters: Array<string> }
