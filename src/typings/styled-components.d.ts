/**
 * This File only exists to fix the styled-components typeings for 4.4.1 with TS 3.9 as noted in
 * this github issue: https://github.com/microsoft/TypeScript/issues/37597#issuecomment-628149946
 *
 * If/when this issue is fixed in Definitely Typed, we can go back to using the @types/styled-components package
 *
 * DO NOT EDIT this file directly, it is copied from styled-components. If you need to make extensions to the
 * styled-components typings, include them in ./styled-components-ext.d.ts
 */
  ...
  declare module 'styled-components' {
    ...
    > =
      ...
      O extends object
        ? WithOptionalTheme<
            Omit<
              ReactDefaultizedProps<C, React.ComponentPropsWithRef<C>> & O,
              A
            > &
    ...
    >
    export type WithThemeFnInterface<
      T extends object
    > = BaseWithThemeFnInterface<AnyIfEmpty<T>>
