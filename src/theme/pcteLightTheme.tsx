...
const palette: PaletteOptions = {
  ...
  primary: {
    ...
    disabled: {
      background: RawColor.Purple400,
    },

    mediumEmphasis: {
      light: RawColor.Purple050,
      main: RawColor.Purple100,
      dark: RawColor.Purple200,
      contrastText: RawColor.Purple800,
      hover: RawColor.Purple200,
      active: RawColor.Purple300,
      disabled: {
    ...
    weakEmphasis: {
      ...
      main: RawColor.White,
      dark: RawColor.Purple050,
      contrastText: RawColor.Purple600,
      hover: RawColor.Purple050,
      active: RawColor.Purple100,
      disabled: {
        text: RawColor.Purple400,
      },
    },
  ...
  default: {
    ...
    weakEmphasis: {
      ...
      selectedHovered: RawColor.Grey300,
      disabled: {
