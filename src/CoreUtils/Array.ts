...
import { array, init, last, member, snoc, sort, uniq } from 'fp-ts/lib/Array'
...
import { ordNumeric } from './Number'
import { ordAlpha } from './String'
 ...
 */
export const union = <A>(xs: A[], ys: A[]): A[] =>
  uniq<A>(setoidStrict)(array.alt(xs, ys))
