...
export const colorHSLAMap = ({
  ...
  const baseColors = {
    ...
    [Colors.DarkGrey]: { h: 0, s: 0, l: 7, a: alpha },
    ...
    [Colors.Admin]: { h: 37, s: 92, l: 53, a: alpha },
    [Colors.AdminAlt]: { h: 37, s: 66, l: 43, a: alpha },
    ...
    [Colors.Impact]: { h: 12, s: 85, l: 51, a: alpha },
    [Colors.ImpactAlt]: { h: 12, s: 93, l: 40, a: alpha },
    [Colors.Training]: { h: 196, s: 75, l: 50, a: alpha },
    // [Colors.TechOps]: { h: 324, s: 60, l: 60, a: alpha },
    [Colors.TechOps]: { h: 325, s: 58, l: 52, a: alpha },
    [Colors.TechOpsAlt]: { h: 325, s: 49, l: 36, a: alpha },
