...
import { ExpandLess, ExpandMore, FiberManualRecord, StarOutline } from '@mui/icons-material'
...
const CustomColumnMenuComponent = (props: GridColumnMenuProps & { color?: string }) => {
  ...
  return (
    <GridColumnMenu hideMenu={hideMenu} colDef={colDef} className={classes.primary} {...other} />
  )
}
