    ...
    <Stack>
      <Stack direction='row' spacing={4}>
        <Stack direction='column' alignItems='flex-start' spacing={2}>
          ...
          <Chip variant='rectangular' avatar={<Avatar>F</Avatar>} label='Rectangular' />
          <Chip
            variant='rectangular'
            avatar={<Avatar>F</Avatar>}
            onDelete={action('onDelete')}
        ...
        <Stack direction='column' alignItems='flex-start' spacing={2}>
          ...
          <Chip clickable variant='rectangular' icon={<FaceIcon />} label='Rectangular' />
          <Chip clickable variant='rectangular' avatar={<Avatar>F</Avatar>} label='Rectangular' />
          <Chip
            clickable
            variant='rectangular'
            avatar={<Avatar>F</Avatar>}
