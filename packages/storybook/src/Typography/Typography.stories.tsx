...
/**
 * The Typography component makes it easy to apply a default set of font weights and sizes in your application. Note: you can create custom variants which can be styled with any custom styles.
 */
...
/**
 * The `lineClamp` prop can be used to truncate text to a certain number of lines, while maintaining accessibility (i.e. the text that overflows will still be read by screen readers)
 */
...
/**
 * As a CSS utility component, the `Typography` supports all system properties. You can use them as prop directly on the component. For instance, a `margin-bottom`:
 */
