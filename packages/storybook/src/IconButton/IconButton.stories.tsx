...
const Template = story<IconButtonProps>(
  (args) => (
    <IconButton variant='contained' color='primary' aria-label='default' {...args}>
...
export const Showcase = story<IconButtonProps>(
  () => (
    <Stack direction='row' spacing={4}>
      ...
      <IconButton color='primary' variant='contained' aria-label='delete' disabled>
        <DeleteIcon />
      </IconButton>
...
export const Variants = story<IconButtonProps>(
  (args) => {
    ...
    return (
      <Stack direction='row' spacing={4}>
        <IconButton aria-label='delete' variant='chromeless' color='primary' {...args}>
          <DeleteIcon />
        </IconButton>
        <IconButton aria-label='delete' variant='outlined' color='primary' {...args}>
          <DeleteIcon />
        </IconButton>
        <IconButton aria-label='delete' variant='contained' color='primary' {...args}>
          <DeleteIcon />
        </IconButton>
      </Stack>
    )
...
export const Sizes = story<IconButtonProps>(
  (args) => (
    <Stack direction='row' spacing={4}>
      <IconButton aria-label='delete' size='small' variant='contained' color='primary' {...args}>
        <DeleteIcon fontSize='inherit' />
      </IconButton>
      <IconButton aria-label='delete' size='medium' variant='contained' color='primary' {...args}>
        <DeleteIcon />
      </IconButton>
      <IconButton aria-label='delete' size='large' variant='contained' color='primary' {...args}>
        <DeleteIcon fontSize='inherit' />
      </IconButton>
    </Stack>
  ),
...
export const Shapes = story<IconButtonProps>(
  () => (
    <Stack direction='row' spacing={4}>
      ...
      <IconButton aria-label='delete' shape='circular' variant='outlined' color='secondary'>
        <DeleteIcon />
      </IconButton>
      <IconButton aria-label='delete' shape='rounded' variant='outlined' color='secondary'>
        <DeleteIcon />
      </IconButton>
    </Stack>
  ),
...
export const Colors = story<IconButtonProps>(() => {
    ...
    return (
      <Stack gap={4}>
        <Stack direction='row' gap={4} alignItems='center'>
          ...
          <IconButton aria-label='delete' color='primary' variant='contained' disabled>
            <DeleteIcon />
          </IconButton>
        </Stack>
        <Stack direction='row' gap={4} alignItems='center'>
          ...
          <IconButton aria-label='delete' color='secondary' variant='outlined' disabled>
            <DeleteIcon />
          </IconButton>
        </Stack>
        <Stack direction='row' gap={4} alignItems='center'>
          ...
          <IconButton aria-label='delete' color='error' variant='outlined' disabled>
            <DeleteIcon />
          </IconButton>
        </Stack>
        <Stack direction='row' gap={4} alignItems='center'>
          <Typography sx={{ minWidth: 200 }}>Secondary (Chromeless)</Typography>
          <IconButton aria-label='delete' color='secondary' variant='chromeless'>
            <DeleteIcon />
          </IconButton>
          <IconButton aria-label='delete' color='secondary' variant='chromeless' disabled>
            <DeleteIcon />
          </IconButton>
        </Stack>
      </Stack>
  ...
  return (
    <Stack spacing={4}>
      {colors.map((color) => (
        <Stack direction='row' spacing={4} alignItems='center' key={`icon-button-color-${color}`}>
          ...
          <IconButton variant='outlined' aria-label='delete' disabled color={color}>
            <DeleteIcon />
          </IconButton>
          <IconButton variant='contained' aria-label='delete' color={color}>
            <DeleteIcon />
          </IconButton>
          <IconButton variant='contained' aria-label='delete' disabled color={color}>
            <DeleteIcon />
          </IconButton>
        </Stack>
      ))}
