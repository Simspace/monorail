...
export default {
  ...
  addons: ['@storybook/addon-links', '@storybook/addon-essentials', '@storybook/addon-a11y', 'creevey'],
  typescript: {
  ...
  webpackFinal: (config: any) => {
    return {
      ...
      resolve: {
        ...
        alias: {
          '@monorail/components$': path.resolve(__dirname, '../../components/src/index.ts'),
          '@monorail/components': path.resolve(__dirname, '../../components/src'),
          '@monorail/themes$': path.resolve(__dirname, '../../themes/src/index.ts'),
          '@monorail/themes': path.resolve(__dirname, '../../themes/src'),
          '@monorail/utils$': path.resolve(__dirname, '../../utils/src/index.ts'),
