 ...
 * Demos:
 *
 * - [Outlined Input](https://simspace.github.io/monorail/main/storybook/?path=/docs/inputs-input-outlinedinput--default)
 ...
 */
export const OutlinedInput: typeof MuiOutlinedInput = MuiOutlinedInput
