 ...
 * Demos:
 *
 * - [Step Label](https://simspace.gitlab.io/engineering/ux-engineering/monorail/main/storybook/?path=/docs/navigation-stepper-steplabel--default)
 ...
 */
export const StepLabel: typeof MuiStepLabel = MuiStepLabel
