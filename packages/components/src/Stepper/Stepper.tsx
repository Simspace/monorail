 ...
 * Demos:
 *
 * - [Stepper](https://simspace.gitlab.io/engineering/ux-engineering/monorail/main/storybook/?path=/docs/navigation-stepper--default)
 ...
 */
export const Stepper: typeof MuiStepper = MuiStepper
