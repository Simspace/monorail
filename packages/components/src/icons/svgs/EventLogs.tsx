...
export const EventLogs = (props: SvgIconProps) => (
  <SvgIcon {...props}>
    <path d="M16 2V4H8V2H6V4H5C3.89 4 3.01 4.9 3.01 6L3 20C3 21.1 3.89 22 5 22H14V20H5V9H19V14H21V6C21 4.9 20.1 4 19 4H18V2H16Z" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
