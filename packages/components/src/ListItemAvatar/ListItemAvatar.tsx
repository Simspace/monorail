 ...
 * Demos:
 *
 * - [List Item Avatar](https://simspace.github.io/monorail/main/storybook/?path=/docs/data-display-list-listitemavatar--default)
 ...
 */
export const ListItemAvatar: typeof MuiListItemAvatar = MuiListItemAvatar
