...
export const PixelLineHeight: Record<TypographyVariant, number> = {
  ...
  H4: Scale.LineHeight24,
  H5: Scale.LineHeight24,
  H6: Scale.LineHeight24,
  ...
  ButtonLarge: Scale.LineHeight24,
  ButtonMedium: Scale.LineHeight24,
  ButtonSmall: Scale.LineHeight24,
...
export const LineHeight: Record<TypographyVariant, number> = {
  ...
  H4: pxToLineHeight(PixelFontSize.H4, PixelLineHeight.H4),
  H5: pxToLineHeight(PixelFontSize.H5, PixelLineHeight.H5),
  H6: pxToLineHeight(PixelFontSize.H6, PixelLineHeight.H6),
  ...
  MonoBody3: pxToLineHeight(PixelFontSize.MonoBody3, PixelLineHeight.MonoBody3),
