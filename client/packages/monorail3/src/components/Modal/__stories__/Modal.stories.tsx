    ...
    return (
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        ...
        <StyledModal
          ...
          open={open}
          onClose={handleClose}
          BackdropComponent={ModalUnstyledBackdrop}
        >
          <Box
            sx={{
              width: 400,
...
export const TransitionsModal = story<ModalProps>(
  ...
  },
  {
    parameters: {
      docs: {
        description: {
          story: `The open/close state of the modal can be animated with a transition component. This component should respect the following conditions:
