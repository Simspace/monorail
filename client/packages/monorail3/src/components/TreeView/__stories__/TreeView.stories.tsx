...
export const Default = story(Template, {
  parameters: {
    docs: {
      description: {
        component: `Tree views can be used to represent a file system navigator displaying folders and files, an item representing a folder can be expanded to reveal the contents of the folder, which may be files, folders, or both.`,
      },
    },
  },
})
...
export const MultiSelection = story(Template, {
  ...
  parameters: {
    docs: {
      description: {
        story: `Tree views also support multi-selection.`,
      },
    },
  },
})
...
export const Controlled = story(
  ...
  },
  {
    parameters: {
      docs: {
        description: {
          story: `The tree view also offers a controlled API.`,
        },
      },
    },
  },
...
export const CustomizedTreeView = story(
  ...
  },
  {
    parameters: {
      docs: {
        description: {
          story: `You can customize icons, tree items, and animation`,
        },
      },
    },
  },
