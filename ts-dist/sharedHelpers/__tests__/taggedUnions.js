import { __, mkTaggedUnion, mkTaggedUnionCustom, mkActionsUnion, } from '../taggedUnions';
describe('mkTaggedUnion', () => {
    const union = mkTaggedUnion()({
        Just: __,
        Nothing: __,
    });
...
describe('mkTaggedUnionCustom', () => {
    const union = mkTaggedUnionCustom()('kind', {
        Yeah: __,
        Nah: __,
    });
    describe('constructors', () => {
