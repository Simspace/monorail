...
import { lensesFromRecord, mkRecordKeyOptional, mkArrayIndexOptional, oLens, } from '../optics';
const testInterface = {
    firstName: 'John',
    lastName: 'Smith',
    age: 33,
...
describe('mkRecordKeyOptional', () => {
    it('should create a properly functioning Optional for a given key', () => {
        ...
        const testOptional = mkRecordKeyOptional(testStr);
...
describe('oLens', () => {
    it('should compose two lenses together', () => {
        const testToAddressLens = Lens.fromProp()('address');
        const addressToStreetLens = Lens.fromProp()('street');
...
//# sourceMappingURL=optics.jest.js.map