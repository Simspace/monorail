...
import { fold, fromTruthyFalsy, getOrElse, getOrEmptyArray, getOrEmptyString, getOrZero, isOption, renderOnSome, toBoolean, toSpreadable, } from '../Option';
...
describe('renderOnSome', () => {
    it('should return null when given a none', () => {
        const numOpt = none;
        const actual = renderOnSome(numOpt, x => createElement('h1', {}, `Num: ${x}`));
        const expected = null;
        expect(actual).toBe(expected);
    });
...
//# sourceMappingURL=Option.jest.js.map