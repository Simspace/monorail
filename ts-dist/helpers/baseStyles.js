...
export const baseFocusStyles = (addPositionToParent = true) => css `
  ${addPositionToParent &&
    css `
      position: relative;
    `};
...
`;
export const floatingOutlineStyles = (color = 'currentColor') => css `
  /**
...
`;
export const floatingBackgroundStyles = (color = 'currentColor') => css `
  /**
  * Using inner element for border to avoid width issue when compared with other base buttons styles
  */
  &:before {
...
`;
export const baseOutlineStyles = (color = Colors.BrandLightBlue, focusColor = Colors.BrandDarkBlue) => css `
...
`;
export const baseChromelessStyles = (color = Colors.BrandLightBlue) => css `
  background: transparent;
  border: 0;
...
`;
export const baseSecondaryStyles = (color = Colors.BrandLightBlue) => css `
...
`;
export const basePrimaryStyles = (color = Colors.BrandLightBlue, backgroundColor = Colors.White) => css `
...
`;
export const baseButtonBarStyles = (color = Colors.Black) => css `
  background: transparent;
  border: 0;
...
`;
export const baseToolBarStyles = (color = Colors.Black) => css `
