...
export const colorHSLAMap = ({ color, alpha = 1, }) => {
    const baseColors = {
        // Base Colors
...
export const convertHSLAMapToCss = (HSLAMap) => `hsla(${HSLAMap.h}, ${HSLAMap.s}%, ${HSLAMap.l}%, ${HSLAMap.a})`;
export const getColor = (color, alpha = 1) => convertHSLAMapToCss(colorHSLAMap({ color, alpha }));
